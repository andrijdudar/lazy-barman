...
// import IconMenu from '../../img/icons/MenuBookIcon.svg';
      ...
      <li>
        <NavLink className={getLinkClass} to="/">
          <div>
            ...
            <strong className='text_button_menu'>Стоп Лист</strong>
          </div>
        </NavLink>
      </li>
      <li>
        <NavLink className={getLinkClass} to="/menu">
          <div>
            <svg
              className={cn('icon_menu',
                { 'has-border-nav': param.pathname === '/menu' })}
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 -960 960 960"
              width="24px"
            ...
            {/* <img className='icon_menu' src={IconMenu} alt="IconMenu" /> */}
            <strong className='text_button_menu'>Меню</strong>
          </div>
        </NavLink>
      </li>
    </ul>
